...
$email = $_SESSION['librarian_login'];
$result = mysqli_query($db_conn, " SELECT * FROM `librarian` WHERE `email` = '$email' ");
if (mysqli_num_rows($result) === 1) {
    $row = mysqli_fetch_assoc($result);
    $librarian_name = $row['first_name'].$row['last_name'];
}
?>
...
<head>
  ...
  <title>LMS</title>
  <link rel="icon" href="../images/book_logo3.png" type="image/gif" sizes="16x16">
  ...
  <div class="wrap">
    ...
    <div class="page-header">
      ...
      <div class="leftside-header">
        <div class="logo ">
          <a class="header-logo " href="index.php" class="on-click">
            <img src="../images/book_logo2.png" alt="LMS">
          </a>
        </div>
      ...
      <div class="rightside-header">
        ...
        <div class="header-section hidden-xs" id="notice-headerbox">
          ...
          <div class="notice" id="alerts-notice">
            <i class="fa fa-bell-o" aria-hidden="true"><span class="badge badge-xs badge-top-right x-danger">7</span>
            </i>
        ...
        <div class="header-section" id="user-headerbox">
          <div class="user-header-wrap">
            ...
            <div class="user-info">
              <span class="user-name"><?= $librarian_name; ?></span>
        ...
        <div class="header-section">
          <a href="logout.php" data-toggle="tooltip" data-placement="left" title="Logout"><i
            ...
            <nav>
              <ul class="nav nav-left-lines" id="main-nav">
                ...
                <li class="<?= $page == 'students.php' ? 'active-item' : ''; ?>">
                  <a href="students.php"><i class="fa fa-users" aria-hidden="true"></i><span>Students</span></a>
                </li>
                <li
                  class="has-child-item close-item <?= $page === 'add_book.php'? 'open-item' : ''; ?><?= $page === 'manage_books.php'? 'open-item' : ''; ?>">
                  <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                  <ul class="nav child-nav level-1" style="">
                    <li class="<?= $page === 'add_book.php' ? 'active-item' : ''; ?>"><a href="add_book.php">Add
                        Book</a>
                    </li>
                    <li class="<?= $page === 'manage_books.php' ? 'active-item' : ''; ?>"><a
                        href="manage_books.php">Manage Books</a>
                    </li>
                  </ul>
                </li>
                <li class="<?= $page === 'issue_book.php' ? 'active-item' : ''; ?>">
                  <a href="issue_book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Issue Book</span></a>
                </li>
                <li class="<?= $page === 'return_issue_book.php' ? 'active-item' : ''; ?>">
                  <a href="return_issue_book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Return Issue
                      Book</span></a>
                </li>
              </ul>
            </nav>
