        ...
        <div class="header-section" id="user-headerbox">
          <div class="user-header-wrap">
            <div class="user-photo">
              <img alt="profile photo" src="../images/students/<?= $std_image ? $std_image : 'std7.jpg' ?>" />
            </div>
            <div class="user-info">
              <span class="user-name"><?= ucwords($std_name); ?></span>
          ...
          <div class="user-options dropdown-box">
            <div class="drop-content basic">
              <ul>
                ...
                <li> <a href="edit_profile.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Profile</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <nav>
              <ul class="nav nav-left-lines" id="main-nav">
                ...
                <li class="<?= $page == 'books.php' ? 'active-item' : ''; ?>">
                  <a href="books.php"><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                </li>
                <li class="<?= $page == 'profile.php' ? 'active-item' : ''; ?>">
                  <a href="profile.php"><i class="fa fa-user" aria-hidden="true"></i><span>Profile</span></a>
                </li>
                <li class="<?= $page == 'edit_profile.php' ? 'active-item' : ''; ?>">
                  <a href="edit_profile.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></i><span>Edit
                      Profile</span></a>
                </li>
              </ul>
            </nav>
